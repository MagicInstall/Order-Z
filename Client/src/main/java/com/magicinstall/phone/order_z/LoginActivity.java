 ...
 */
public class LoginActivity extends ActivityManagerApplication.ManagedActivity implements LoaderCallbacks<Cursor> {
    ...
    private ArrayAdapter mCompanyApapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCompanyApapter = new ArrayAdapter(this, android.R.layout.simple_spinner_item, com_names);
        // TODO: 暂时用默认的样式
        mCompanyApapter.setDropDownViewResource(android.R.layout.simple_list_item_single_choice);
        // 企业转盘
        mCompanySpinner = (Spinner) findViewById(R.id.Login_company_spinner);
        mCompanySpinner.setAdapter(mCompanyApapter);
        ...
        mUserView = (AutoCompleteTextView) findViewById(R.id.login_user_textview);
...
//    }
    ...
    private void gotoForgotPasswordActivity() {
        Log.i(TAG, mUserView.getText().toString());
